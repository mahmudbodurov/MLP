...
public class PatternRecognition 
{
	 ...
	 */
	public PatternRecognition(int imgSize, int nPatterns, double learningRate, ActivationFunction activationFunction)
	{
		int[] layers = new int[]{ imgSize * imgSize, imgSize, nPatterns };
		fNPatterns = nPatterns;
		fImageSize = imgSize;
		
		fNetwork = new Network(layers, learningRate, activationFunction);		
	}
